...
class Net(nn.Module):
    def __init__(self, video_modality_dim, text_dim, sequence_cluster=8,  text_cluster=32):
        super(Net, self).__init__()
        
        self.sequence_pooling = NetVLAD(feature_size=video_modality_dim['sequence'][1],
                cluster_size=sequence_cluster)
    ...
    def forward(self, text, video, ind, conf=True):
        ...
        aggregated_video['sequence'] = self.sequence_pooling(video['sequence'])
